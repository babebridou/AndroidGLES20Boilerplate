...
public class TextureReader {
    public static TextureBuffer readTexture(String filename) throws IOException {
        return readTexture(filename, false);
    }

    public static TextureBuffer readTexture(String filename, boolean storeAlphaChannel) throws IOException {
    ...
    private static TextureBuffer readPixels(BufferedImage img, boolean storeAlphaChannel) {
        ...
        return new TextureBuffer(unpackedPixels, img.getWidth(), img.getHeight());
    }
    ...
    public static class TextureBuffer {
        ...
        public TextureBuffer(ByteBuffer pixels, int width, int height) {
            this.height = height;
            this.pixels = pixels;
            this.width = width;
        }
